	...
	jQuery.extend({
      jHighChart:function (setting) {
    	  var options = $.extend({
              ...
              legend:{enabled:false,layout:"",align:"",verticalAlign:"",floating:true,x:"",y:"",backgroundColor:"#FFFFFF"},
              //数据点选项
                  ...
                  if (_chartType == "pie") {    //饼图需要指定类型，且显示数据格式不同
                      if (index < 1) {    //饼图只有一个维度
                          ...
                          $(_series).each(function (idx, dataItem) {
                              ...
                              $(_datas).each(function(i,value){   //饼图只有一个维度，只需迭代一次
                        		  var _y = value.y;
              ...
              var chart = new Highcharts.Chart({
                  ...
                  plotOptions: {
                      ...
                      column: {
                          ...
                          dataLabels:{
                        	  enabled:_plotOptions.dataEnable //是否显示数据标签
                          }
                      },
                      scatter: {
                          marker: {
