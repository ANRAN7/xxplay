...
<div class="form-body">
	<div class="row">
		<div class="col-md-6 form-group">
			<label class="col-md-2 control-label label-text" for="inputName"><s:text
					name="menKey.case.sel.caseno" />：</label>
			<div class="col-md-9 ">
		...
		<div class="col-md-6 form-group">
			<label class="col-md-2 control-label label-text" for="inputName"><s:text
					name="menKey.case.sel.clueno" />：</label>
			<div class="col-md-9">
	...
	<div class="row">
		<div class="col-md-6 form-group">
			<label class="col-md-2 control-label label-text" for="inputName"><s:text
					name="menKey.case.sel.accno" />：</label>
			<div class="col-md-9">
		...
		<div class="col-md-6 form-group">
			<label class="col-md-2 control-label label-text" for="inputName"><s:text
					name="menKey.case.sel.casetime" />：</label>
			<div class="col-md-9 ">
	...
	<div class="row">
		<div class="col-md-6 form-group">
			<label class="col-md-2 control-label label-text" for="inputName"><s:text
					name="menKey.warn.detail.risk" />：</label>
			<div class="col-md-9 ">
		...
		<div class="col-md-6 form-group">
			<label class="col-md-2 control-label label-text" for="inputName"><s:text
					name="menKey.clue.warndate" />：</label>
			<div class="col-md-9">
				<div class="col-md-5 input-icon col-md-m">
					<i class="fa fa-calendar"></i> <input readonly="readonly"
						id="beginDate" class="form-control inputText" type="text"
