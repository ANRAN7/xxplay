			...
			<div class="topbar-main">
				...
				<ul class="nav navbar-nav    ">
					...
					<li class="mega-menu-dropdown mega-menu-full"><a
						href="javascript:;" data-toggle="dropdown" class="dropdown-toggle">Extras
							&nbsp;<i class="fa fa-angle-down"></i>
					</a>
						<ul class="dropdown-menu">
							<li>
				...
				<ul class="nav navbar navbar-top-links navbar-right mbn">
								...
								<div class="dropdown-slimscroll">
									<ul>
										...
										<li><a href="extra-user-list.html" target="_blank"><span
												...
												Sent<span class="pull-right text-muted small">15 mins
													ago</span></a></li>
										<li><a href="extra-user-list.html" target="_blank"><span
												class="label label-green"><i class="fa fa-tasks"></i></span>New
												Task<span class="pull-right text-muted small">18 mins
													ago</span></a></li>
										<li><a href="extra-user-list.html" target="_blank"><span
								...
								<div class="dropdown-slimscroll">
									<ul>
										<li><a href="email-view-mail.html" target="_blank"><span
												class="avatar"><img
													src="../uifaces/faces/twitter/kolage/48.jpg"
					...
					<li class="dropdown topbar-user"><a data-hover="dropdown"
						href="#" class="dropdown-toggle"><img
							...
							class="hidden-xs">John Doe</span>&nbsp;<span class="caret"></span>
					</a>
					...
					<li class="dropdown hidden-xs">
						<!--BEGIN THEME SETTING--> <a id="theme-setting"
						href="javascript:;" data-hover="dropdown" data-step="1"
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
							Sed eleifend et nisl eget porta. Curabitur elementum sem molestie
							nisl varius, eget tempus odio molestie. Nunc vehicula sem arcu,
							eu pulvinar neque cursus ac. Aliquam ultricies lobortis magna et
							aliquam. Vestibulum egestas eu urna sed ultricies. Nullam
							pulvinar dolor vitae quam dictum condimentum. Integer a sodales
							elit, eu pulvinar leo. Nunc nec aliquam nisi, a mollis neque. Ut
							vel felis quis tellus hendrerit placerat. Vivamus vel nisl non
							magna feugiat dignissim sed ut nibh. Nulla elementum, est a
							pretium hendrerit, arcu risus luctus augue, mattis aliquet orci
							ligula eget massa. Sed ut ultricies felis.</p>
					</div>
			...
			<div class="chat-inner">
				...
				<div id="group-1" class="chat-group">
					<strong>Favorites</strong><a href="#"><span
						...
						class="user-status is-busy"></span><small>Nathaniel Morris</small><span
						class="badge badge-info is-hidden">0</span></a><a href="#"><span
				...
				<div class="chat-content">
					<ul class="chat-box-body">
						<li>
							<p>
								<img
									src="../uifaces/faces/twitter/kolage/128.jpg"
						...
						<li class="odd">
							<p>
								<img
									src="../uifaces/faces/twitter/alagoon/48.jpg"
