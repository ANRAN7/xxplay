...
<body>
	...
	<%@include file="../../page/include/include_file_upload_vendorjs.jsp"%>
</body>
<%@include file="../../page/include/include_base_js.jsp"%>
<%@include file="../../page/include/include-jquery-step.jsp"%>
<%@include file="../../page/include/include_file_upload.jsp"%>
<!-- 一个页面存在多个上传 -->
