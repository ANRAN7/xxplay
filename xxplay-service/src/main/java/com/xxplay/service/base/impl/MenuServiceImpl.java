...
public class MenuServiceImpl implements IMenuService{
	...
	public List<MenuItem> getAdminMenuItem(Admin admin) throws ServiceException {
		...
		//获取所有菜单
		List<MenuBean> menuBean = AppContextUtils.getMenus();
		
		List<Menu> menu2 = new ArrayList<Menu>();
		BeanUtils.copyProperties(menuBean, menu2);
	...
	public Map<Menu, List<MenuItem>> getMenuMap() {
		//获取所有的菜单
		List<MenuBean> menuBeans = AppContextUtils.getMenus();
		
		List<Menu> menus = new ArrayList<Menu>();
		BeanUtils.copyProperties(menuBeans, menus);
